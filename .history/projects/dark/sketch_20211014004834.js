...
function preload() {
  ...
  images[0].push(loadImage('assets/water.png'));
  images[1].push(loadImage('assets/sand.png'));
  images[1].push(loadImage('assets/grass.png'));
  images[3].push(loadImage('assets/forest.png'));
}

function setup() {
  createCanvas(1080, 720);
  w = canvasWidth / tileSize + buffer;
  h = canvasHeight / tileSize + buffer;
