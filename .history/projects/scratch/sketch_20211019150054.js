...
function setup() {
    ...
    //       pendulums[i][j] = new Pendulum(i*((canvasWidth+80)/cols), j*((canvasHeight+80)/rows), c/0.6);
    //     }
    // }

    for(let i = 0; i < cols; i++) {
        pendulums[i] = new Pendulum(i*((canvasWidth)/cols), i*((canvasHeight)/cols), 50);
    }
