...
function setup(){
    ...
    detailA = createSlider(15, 200, 1);
    detailA.position(myCanvas.width + 5, (myCanvas.height)/2);
    detailA.style('height', '400px');
    detailA.style("transform","rotate(90deg)");

    detailB = createSlider(15, 200, 1);
    detailB.position(myCanvas.width + 30, (myCanvas.height)/2);
    detailB.style('height', '400px');
    detailB.style("transform","rotate(90deg)");
}
